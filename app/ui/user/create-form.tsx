...
import { createUser } from "@/app/lib/data-mongodb";
                ...
                <div className="rounded-md bg-gray-50 p-4 md:p-6">
                    ...
                    <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
                        <div className="flex gap-4">
                            {props.servicos?.map((serv: string) => (
                                <div className="flex items-center" key={serv + "item"}>
                                    <input
                                        id={serv}
                                        name="status"
                                        type="checkbox"
                                    ...
                                    >
                                        {serv}<ClockIcon className="h-4 w-4" />
                                    </label>
                                </div>
                            ))}
